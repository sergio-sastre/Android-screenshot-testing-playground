...
class AccessibilityFontWeightTest(
    private val fontWeight: FontWeight,
) {
    companion object {
        @JvmStatic
        @ParameterizedRobolectricTestRunner.Parameters
        fun testItemProvider(): Array<FontWeight> =
            arrayOf(FontWeight.THIN, FontWeight.BOLD)
    }
    ...
    val activityScenarioForViewRule =
        RobolectricActivityScenarioForViewRule(
            ...
            config = ViewConfigItem(fontWeight = fontWeight)
        )
    ...
    fun snapMemoriseVHWithAccessibility() {
        ...
        viewHolder
            .itemView
            .captureRoboImage(
                filePath = filePath("MemoriseViewHolder_FontWeight_${fontWeight.name}")
            )
    }
    ...
    fun snapTrainingVHWithAccessibility() {
        ...
        viewHolder.itemView
            .captureRoboImage(
                filePath = filePath("TrainingViewHolder_FontWeight_${fontWeight.name}"),
            )
    }
}