...
class AccessibilityDisplaySizeTest(
    private val displaySize: DisplaySize,
) {
    companion object {
        @JvmStatic
        @ParameterizedRobolectricTestRunner.Parameters
        fun testItemProvider(): Array<DisplaySize> =
            arrayOf(DisplaySize.SMALL, DisplaySize.LARGEST)
    }
    ...
    val activityScenarioForViewRule =
        RobolectricActivityScenarioForViewRule(
            ...
            config = ViewConfigItem(displaySize = displaySize)
        )
    ...
    fun snapMemoriseVHWithAccessibility() {
        ...
        viewHolder
            .itemView
            .captureRoboImage(
                filePath = filePath("MemoriseViewHolder_DisplaySize_${displaySize.name}")
            )
    }
    ...
    fun snapTrainingVHWithAccessibility() {
        ...
        viewHolder.itemView
            .captureRoboImage(
                filePath = filePath("TrainingViewHolder_DisplaySize_${displaySize.name}"),
            )
    }
}